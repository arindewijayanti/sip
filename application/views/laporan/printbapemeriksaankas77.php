...
<tr><td width="5%">b. </td>     <td width="65%">Saldo Bank Sumut AC 2511</td>	<td width="25%">= <?='Rp'.number_format($saldobank['saldo'],0,'.','.'); ?></td></tr>
...
<tr><td width="5%"></td>     <td width="65%">Jumlah</td>	<td width="25%">= <?='Rp'.number_format($saldobank['saldo'],0,'.','.'); ?></td></tr>
<tr><td width="5%"></td>     <td width="65%">Saldo Uang menurut Buku Kas, Register Buku Kas</td>	<td width="25%">= <?='Rp'.number_format($h['totalpenerimaan']-$h['totalpengeluaran']+$hbpp['totalpenerimaanbpp']-$hbpp['totalpengeluaranbpp']+$hbbp['totalpenerimaanbbp']-$hbbp['totalpengeluaranbbp'],0,'.','.'); ?></td></tr>
<tr><td width="5%"></td><td width="65%"></td><td width="5%"><hr  color="black" size="2px"/></td></tr>
