...
<section id="services" class="services">
      ...
      <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">Laporan Posisi Kas Harian</li>
      </ol>
<!-- Example DataTables Card-->
<div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-plus"></i> Laporan Posisi Kas Harian</div>
        <div class="card-body">
          <div class="table-responsive">
             <div class="container">

        <form action="<?php echo base_url()?>laporan/printposisikasharian/" method="post" enctype="multipart/form-data">
