...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 26, 2021 at 02:14 AM
...
(8, 2021, 12, 8, 8, 'admin', '35'),
(9, 2021, 12, 9, 9, 'admin', '35');
...
CREATE TABLE `tbl_bbp` (
  ...
  `no_bukti` varchar(128) DEFAULT NULL,
...
(1, '2021-04-26', '89', '89', '89', 'bpp uraian', 900, 900, 'admin', '35');
...
CREATE TABLE `tbl_transaksi` (
  ...
  `tanggal` date NOT NULL,
  `no_sp2d` varchar(128) DEFAULT NULL,
  `no_sts` varchar(128) DEFAULT NULL,
  `no_lainlain` varchar(128) DEFAULT NULL,
  `uraian` varchar(100) NOT NULL,
  `penerimaan` double NOT NULL,
  `pengeluaran` double NOT NULL,
...
(16, '2020-12-31', NULL, NULL, NULL, 'Saldo Bank Tahun 2020', 104313662823.43, 0, 'Transaksi Utama', 'admin', '35'),
(17, '2021-02-05', NULL, NULL, NULL, 'Pot . IWP,PPh 21 & Taperum Gaji Februari 2021', 355981899, 355981899, 'Transaksi Tambahan', 'admin', '35'),
(19, '2021-02-05', NULL, NULL, NULL, 'Pemby. PPN & PPh', 0, 0, 'Transaksi Tambahan', 'admin', '35'),
(20, '2021-02-05', NULL, NULL, NULL, 'JKK, JKM', 127943180, 127943180, 'Transaksi Tambahan', 'admin', '35'),
(21, '2021-02-08', NULL, NULL, NULL, 'Pot . IWP,PPh 21 & Taperum Gaji Februari 2021', 1242676766, 1242676766, 'Transaksi Tambahan', 'admin', '35'),
(22, '2021-02-09', NULL, NULL, NULL, 'Pot . IWP,PPh 21 & Taperum Gaji Februari 2021', 325770689, 325770689, 'Transaksi Tambahan', 'admin', '35'),
(23, '2021-02-10', NULL, NULL, NULL, 'Pemby. PPN & PPh', 0, 0, 'Transaksi Tambahan', 'admin', '35'),
(24, '2021-02-18', NULL, NULL, NULL, 'Pot . IWP,PPh 21 & Taperum Gaji Terusa Februari ', 7471939, 7471939, 'Transaksi Tambahan', 'admin', '35'),
(25, '2021-02-19', NULL, NULL, NULL, 'Pot . IWP,PPh 21 & Taperum Gaji Februari 2021', 48612637, 48612637, 'Transaksi Tambahan', 'admin', '35'),
(26, '2021-02-22', NULL, NULL, NULL, 'Pot . IWP,PPh 21 & Taperum Gaji Februari 2021', 1043745, 1043745, 'Transaksi Tambahan', 'admin', '35'),
(27, '2021-02-23', NULL, NULL, NULL, 'Pemby. PPN & PPh', 1467750, 1467750, 'Transaksi Tambahan', 'admin', '35'),
(28, '2021-01-14', NULL, NULL, NULL, 'Pot. IWP, PPh 21 & Taperum Gaji Januari 2021', 65748880, 65748880, 'Transaksi Tambahan', 'admin', '35'),
(29, '2021-01-15', NULL, NULL, NULL, 'Pot. IWP, PPh 21 & Taperum Gaji Januari 2021', 1597879303, 1597879303, 'Transaksi Tambahan', 'admin', '35'),
(30, '2021-01-15', NULL, NULL, NULL, 'JKK, JKM', 128330322, 128330322, 'Transaksi Tambahan', 'admin', '35'),
(31, '2021-01-15', NULL, NULL, NULL, 'Pemby. PPN & PPh', 269802799, 269802799, 'Transaksi Tambahan', 'admin', '35'),
(32, '2021-01-19', NULL, NULL, NULL, 'Pemby. PPN & PPh', 22880746, 22880746, 'Transaksi Tambahan', 'admin', '35'),
(33, '2021-01-20', NULL, NULL, NULL, 'Pemby. PPN & PPh', 22843075, 22843075, 'Transaksi Tambahan', 'admin', '35'),
(34, '2021-01-29', NULL, NULL, NULL, 'JKK, JKM', 460656, 460656, 'Transaksi Tambahan', 'admin', '35'),
(35, '2021-01-29', NULL, NULL, NULL, 'Pemby. PPN & PPh', 153842964, 153842964, 'Transaksi Tambahan', 'admin', '35'),
(36, '2021-01-14', NULL, NULL, NULL, 'KDH & WKDH Gaji Januari 2020', 0, 11841621, 'Transaksi Utama', 'admin', '35'),
(37, '2021-01-14', NULL, NULL, NULL, 'Sekretariat Daerah Gaji Januari 2020', 0, 574633559, 'Transaksi Utama', 'admin', '35'),
(38, '2021-01-15', NULL, NULL, NULL, 'Badan Keuangan Daerah Gaji Januari 2021', 0, 473901583, 'Transaksi Utama', 'admin', '35'),
(39, '2021-01-15', NULL, NULL, NULL, 'Dinas Pendidikan Gaji Januari 2021', 0, 7314198947, 'Transaksi Utama', 'admin', '35'),
(40, '2021-01-15', NULL, NULL, NULL, 'Kantor Satpol-PP Gaji Januari 2021', 0, 191929410, 'Transaksi Utama', 'admin', '35'),
(41, '2021-01-15', NULL, NULL, NULL, 'Dinas Kesehatan Gaji Januari 2021', 0, 2105606040, 'Transaksi Utama', 'admin', '35'),
(42, '2021-01-15', NULL, NULL, NULL, 'Dinas Perumahan Rakyat dan Kawasan Permukiman Gaji Januari 2021', 0, 140597982, 'Transaksi Utama', 'admin', '35'),
(43, '2021-01-15', NULL, NULL, NULL, 'Dinas Sosial Gaji Januari 2021', 0, 128347719, 'Transaksi Utama', 'admin', '35'),
(44, '2021-01-15', NULL, NULL, NULL, 'Dinas Perpustakaan Gaji Januari 2021', 0, 166650005, 'Transaksi Utama', 'admin', '35'),
(45, '2021-01-15', NULL, NULL, NULL, 'Badan Perencanaan, Penelitian dan Pengembangan Daerah Gaji Januari 2021', 0, 192501570, 'Transaksi Utama', 'admin', '35'),
(46, '2021-01-15', NULL, NULL, NULL, 'Dinas Pemberdayaan Perempuan dan Perlindungan Anak Gaji Januari 2021', 0, 79794854, 'Transaksi Utama', 'admin', '35'),
(47, '2021-01-15', NULL, NULL, NULL, 'Kec. Psp Tenggara Gaji Januari 2021', 0, 187005776, 'Transaksi Utama', 'admin', '35'),
(48, '2021-01-15', NULL, NULL, NULL, 'Kantor Kesbang dan Politik Gaji Januari 2021', 0, 122274431, 'Transaksi Utama', 'admin', '35'),
(49, '2021-01-15', NULL, NULL, NULL, 'Dinas Penataan Ruang dan Permukiman Gaji Januari 2021', 0, 237531046, 'Transaksi Utama', 'admin', '35'),
(50, '2021-01-15', NULL, NULL, NULL, 'Badan Penanggulangan Bencana Daerah Gaji Januari 2021', 0, 69136385, 'Transaksi Utama', 'admin', '35'),
(51, '2021-01-15', NULL, NULL, NULL, 'Badan Kepegawaian dan Pengembangan SDM Gaji Januari 2021', 0, 130599989, 'Transaksi Utama', 'admin', '35'),
(52, '2021-01-15', NULL, NULL, NULL, 'Dinas Lingkungan Hidup Gaji Januari 2021', 0, 241341162, 'Transaksi Utama', 'admin', '35'),
(53, '2021-01-15', NULL, NULL, NULL, 'Inspektorat Gaji Januari 2021', 0, 209381856, 'Transaksi Utama', 'admin', '35'),
(54, '2021-01-15', NULL, NULL, NULL, 'Dinas Penanaman Modal dan Pelayanan Satu Pintu Gaji Januari 2021', 0, 138200276, 'Transaksi Utama', 'admin', '35'),
(55, '2021-01-15', NULL, NULL, NULL, 'RSUD Gaji Januari 2021', 0, 1227269974, 'Transaksi Utama', 'admin', '35'),
(56, '2021-01-15', NULL, NULL, NULL, 'Kec. Psp Selatan Gaji Januari 2021', 0, 431229137, 'Transaksi Utama', 'admin', '35'),
(57, '2021-01-15', NULL, NULL, NULL, 'Kec. Psp Angkola Julu Gaji Januari 2021', 0, 115195670, 'Transaksi Utama', 'admin', '35'),
(58, '2021-01-15', NULL, NULL, NULL, 'Dinas Ketenagakerjaan Gaji Januari 2021', 0, 153801913, 'Transaksi Utama', 'admin', '35'),
(59, '2021-01-18', NULL, NULL, NULL, 'Kec. Psp Utara Gaji Januari 2021', 0, 576090983, 'Transaksi Utama', 'admin', '35'),
(60, '2021-01-18', NULL, NULL, NULL, 'Kec. Psp Hutaimbaru Gaji Januari 2021', 0, 218492059, 'Transaksi Utama', 'admin', '35'),
(61, '2021-01-18', NULL, NULL, NULL, 'Kec. Psp Batunadua Gaji Januari 2021', 0, 145985504, 'Transaksi Utama', 'admin', '35'),
(62, '2021-01-18', NULL, NULL, NULL, 'Dinas Pariwisata Gaji Januari 2021', 0, 119861960, 'Transaksi Utama', 'admin', '35'),
(63, '2021-01-18', NULL, NULL, NULL, 'Dinas Komunikasi dan Informatika Gaji 2021', 0, 94014403, 'Transaksi Utama', 'admin', '35'),
(64, '2021-01-18', NULL, NULL, NULL, 'Dinas Ketahanan Pangan Gaji Januari 2021', 0, 132301668, 'Transaksi Utama', 'admin', '35'),
(65, '2021-01-18', NULL, NULL, NULL, 'Dinas Perdagangan Gaji Januari 2021', 0, 189640664, 'Transaksi Utama', 'admin', '35'),
(66, '2021-01-18', NULL, NULL, NULL, 'Dinas Pengendalian Penduduk dan Keluarga Berencana Gaji Januari 2021', 0, 152299781, 'Transaksi Utama', 'admin', '35'),
(67, '2021-01-18', NULL, NULL, NULL, 'Dinas Pemberdayaan Masyarakat dan Desa Gaji Januari 2021', 0, 127105304, 'Transaksi Utama', 'admin', '35'),
(68, '2021-01-18', NULL, NULL, NULL, 'Dinas Pertanian Gaji Januari 2021', 0, 316341697, 'Transaksi Utama', 'admin', '35'),
(69, '2021-01-18', NULL, NULL, NULL, 'Dinas Pemadam Kebakaran Gaji Januari 2021', 0, 117355379, 'Transaksi Utama', 'admin', '35'),
(70, '2021-01-18', NULL, NULL, NULL, 'Dinas Perhubungan Gaji Januari 2021', 0, 199484397, 'Transaksi Utama', 'admin', '35'),
(71, '2021-01-19', NULL, NULL, NULL, 'Dinas Administrasi Kependudukan dan Pencatatan Sipil Gaji Januari 2021', 0, 202682046, 'Transaksi Utama', 'admin', '35'),
(72, '2021-01-20', NULL, NULL, NULL, 'Sekr. DPRD Gaji Januari 2021', 0, 200707775, 'Transaksi Utama', 'admin', '35'),
(73, '2021-01-29', NULL, NULL, NULL, 'Sekrt. DPRP Gaji Pimpinan dan Anggota DPRD Januari 2021', 0, 474492015, 'Transaksi Utama', 'admin', '35'),
(74, '2021-01-29', NULL, NULL, NULL, 'Sekrt. DPRP Tunj. Transportasi Anggota DPRD Januari 2021', 0, 459000000, 'Transaksi Utama', 'admin', '35'),
(75, '2021-01-29', NULL, NULL, NULL, 'Sekrt. DPRP Tunj. Komunikasi Insentif (TKI) Pimpinan dan Anggota DPRD Januari 2021', 0, 189000000, 'Transaksi Utama', 'admin', '35'),
(76, '2021-01-29', NULL, NULL, NULL, 'Per. Rakyat, KP Pembayaran Uang Persediaan (UP) TA. 2021', 0, 485894000, 'Transaksi Utama', 'admin', '35'),
(77, '2021-01-29', NULL, NULL, NULL, 'Bakeuda Permintaan UP TA. 2021', 0, 670711000, 'Transaksi Utama', 'admin', '35'),
(78, '2021-02-05', NULL, NULL, NULL, 'Badan Keuangan Daerah Gaji Februari 2021', 0, 472323691, 'Transaksi Utama', 'admin', '35'),
(79, '2021-02-05', NULL, NULL, NULL, 'Dinas Pemberdayaan Perempuan dan Perlindungan Anak Gaji Februari 2021', 0, 80010953, 'Transaksi Utama', 'admin', '35'),
(80, '2021-02-05', NULL, NULL, NULL, 'Kantor Kesbang dan Politik Gaji Februari 2021', 0, 127058984, 'Transaksi Utama', 'admin', '35'),
(81, '2021-02-05', NULL, NULL, NULL, 'Dinas Sosial Gaji Februari 2021', 0, 128347719, 'Transaksi Utama', 'admin', '35'),
(82, '2021-02-05', NULL, NULL, NULL, 'Dinas Komunikasi dan Informatika Gaji Februari 2021', 0, 94014403, 'Transaksi Utama', 'admin', '35'),
(83, '2021-02-05', NULL, NULL, NULL, 'Dinas Pariwisata Gaji Februari 2021', 0, 126038168, 'Transaksi Utama', 'admin', '35'),
(84, '2021-02-05', NULL, NULL, NULL, 'Dinas Lingkungan Hidup Gaji Februari 2021', 0, 241341162, 'Transaksi Utama', 'admin', '35'),
(85, '2021-02-05', NULL, NULL, NULL, 'Dinas Penataan Ruang dan Permukiman Gaji Februari 2021', 0, 235877446, 'Transaksi Utama', 'admin', '35'),
(86, '2021-02-05', NULL, NULL, NULL, 'Inspektorat Gaji Februari 2021', 0, 209381856, 'Transaksi Utama', 'admin', '35'),
(87, '2021-02-05', NULL, NULL, NULL, 'Kec. Psp Tenggara Gaji Februari 2021', 0, 186688626, 'Transaksi Utama', 'admin', '35'),
(88, '2021-02-05', NULL, NULL, NULL, 'Dinas Perumahan Rakyat dan Kawasan Permukiman Gaji Februari 2021', 0, 139385382, 'Transaksi Utama', 'admin', '35'),
(89, '2021-02-05', NULL, NULL, NULL, 'Dinas Ketenagakerjaan Gaji Februari 2021', 0, 154171163, 'Transaksi Utama', 'admin', '35'),
(90, '2021-02-05', NULL, NULL, NULL, 'Badan Perencanaan, Penelitian dan Pengembangan Daerah Gaji Februari 2021', 0, 190969612, 'Transaksi Utama', 'admin', '35'),
(91, '2021-02-05', NULL, NULL, NULL, 'Dinas Pertanian Gaji Februari 2021', 0, 315966384, 'Transaksi Utama', 'admin', '35'),
(92, '2021-02-05', NULL, NULL, NULL, 'Sekretariat Daerah Gaji Februari 2021', 0, 574264409, 'Transaksi Utama', 'admin', '35'),
(93, '2021-02-05', NULL, NULL, NULL, 'KDH & WKDH Gaji Februari 2021', 0, 11841621, 'Transaksi Utama', 'admin', '35'),
(94, '2021-02-08', NULL, NULL, NULL, 'Dinas Pengendalian Penduduk dan Keluarga Berencana Gaji Februari 2021', 0, 151972131, 'Transaksi Utama', 'admin', '35'),
(95, '2021-02-08', NULL, NULL, NULL, 'Kec. Psp Utara Gaji Februari 2021', 0, 564429227, 'Transaksi Utama', 'admin', '35'),
(96, '2021-02-08', NULL, NULL, NULL, 'Kantor Satpol-PP Gaji Februari 2021', 0, 181363899, 'Transaksi Utama', 'admin', '35'),
(97, '2021-02-08', NULL, NULL, NULL, 'Kec. Psp Batunadua Gaji Februari 2021', 0, 146134302, 'Transaksi Utama', 'admin', '35'),
(98, '2021-02-08', NULL, NULL, NULL, 'Dinas Administrasi Kependudukan dan Pencatatan Sipil Gaji Februari 2021', 0, 202682046, 'Transaksi Utama', 'admin', '35'),
(99, '2021-02-08', NULL, NULL, NULL, 'Kec. Psp Angkola Julu Gaji Februari 2021', 0, 114826520, 'Transaksi Utama', 'admin', '35'),
(100, '2021-02-08', NULL, NULL, NULL, 'Badan Penanggulangan Bencana Daerah Gaji Februari 2021', 0, 64159019, 'Transaksi Utama', 'admin', '35'),
(101, '2021-02-08', NULL, NULL, NULL, 'RSUD Gaji Februari 2021', 0, 1227269974, 'Transaksi Utama', 'admin', '35'),
(102, '2021-02-08', NULL, NULL, NULL, 'Dinas Perhubungan Gaji Februari 2021', 0, 199484397, 'Transaksi Utama', 'admin', '35'),
(103, '2021-02-08', NULL, NULL, NULL, 'Dinas Pemadam Kebakaran Gaji Februari 2021', 0, 117355379, 'Transaksi Utama', 'admin', '35'),
(104, '2021-02-08', NULL, NULL, NULL, 'Dinas Perpustakaan Gaji Februari 2021', 0, 166650005, 'Transaksi Utama', 'admin', '35'),
(105, '2021-02-08', NULL, NULL, NULL, 'Sekr. DPRD Gaji Februari 2021', 0, 200707775, 'Transaksi Utama', 'admin', '35'),
(106, '2021-02-08', NULL, NULL, NULL, 'Dinas Pendidikan Gaji Februari 2021', 0, 7293751905, 'Transaksi Utama', 'admin', '35'),
(107, '2021-02-08', NULL, NULL, NULL, 'Badan Kepegawaian dan Pengembangan SDM Gaji Februari 2021', 0, 130840587, 'Transaksi Utama', 'admin', '35'),
(108, '2021-02-08', NULL, NULL, NULL, 'PUD Pembayaran Uang Persediaan (UP) TA. 2021', 0, 605752000, 'Transaksi Utama', 'admin', '35'),
(109, '2021-02-08', NULL, NULL, NULL, 'Bapelitbang Pembayaran UP TA. 2021', 0, 333121000, 'Transaksi Utama', 'admin', '35'),
(110, '2021-02-09', NULL, NULL, NULL, 'Dinas Pemberdayaan Masyarakat dan Desa Gaji Februari 2021', 0, 126255504, 'Transaksi Utama', 'admin', '35'),
(111, '2021-02-09', NULL, NULL, NULL, 'Kec. Psp Hutaimbaru Gaji Februari 2021', 0, 213834833, 'Transaksi Utama', 'admin', '35'),
(112, '2021-02-09', NULL, NULL, NULL, 'Dinas Kesehatan Gaji Februari 2021', 0, 2097607474, 'Transaksi Utama', 'admin', '35'),
(113, '2021-02-09', NULL, NULL, NULL, 'Dinas Perdagangan Gaji Februari 2021', 0, 189640664, 'Transaksi Utama', 'admin', '35'),
(114, '2021-02-09', NULL, NULL, NULL, 'Dinas Penanaman Modal dan Pelayanan Satu Pintu Gaji Februari 2021', 0, 136256722, 'Transaksi Utama', 'admin', '35'),
(115, '2021-02-09', NULL, NULL, NULL, 'Dinas Kesehatan Pangan Gaji Februari 2021', 0, 130322792, 'Transaksi Utama', 'admin', '35'),
(116, '2021-02-09', NULL, NULL, NULL, 'Kominfo Permintaan UP TA. 2021', 0, 79835000, 'Transaksi Utama', 'admin', '35'),
(117, '2021-02-10', NULL, NULL, NULL, 'P2KB Permintaan UP TA. 2021', 0, 475283000, 'Transaksi Utama', 'admin', '35'),
(118, '2021-02-10', NULL, NULL, NULL, 'Pemadam, KP Permintaan UP TA. 2021', 0, 165181000, 'Transaksi Utama', 'admin', '35'),
(119, '2021-02-10', NULL, NULL, NULL, 'Sekrt. DPRD Pembayaran Uang Persediaan (UP) 2021', 0, 1669615000, 'Transaksi Utama', 'admin', '35'),
(120, '2021-02-10', NULL, NULL, NULL, 'DLH Permintaan UP TA. 2021', 0, 349976000, 'Transaksi Utama', 'admin', '35'),
(121, '2021-02-10', NULL, NULL, NULL, 'Kec. Psp Tenggara Permintaan UP TA. 2021', 0, 91960000, 'Transaksi Utama', 'admin', '35'),
(122, '2021-02-10', NULL, NULL, NULL, 'Ketenagakerjaan Permintaan UP TA. 2021', 0, 253642000, 'Transaksi Utama', 'admin', '35'),
(123, '2021-02-15', NULL, NULL, NULL, 'P3A Permintaan UP TA. 2021', 0, 259953000, 'Transaksi Utama', 'admin', '35'),
(124, '2021-02-16', NULL, NULL, NULL, 'Penanaman Modal, PTSP Permintaan UP TA. 2021', 0, 317117000, 'Transaksi Utama', 'admin', '35'),
(125, '2021-02-16', NULL, NULL, NULL, 'Perpustakaan Permintaan UP TA. 2021', 0, 101549000, 'Transaksi Utama', 'admin', '35'),
(126, '2021-02-16', NULL, NULL, NULL, 'Satpol-PP Permintaan UP TA. 2021', 0, 139847000, 'Transaksi Utama', 'admin', '35'),
(127, '2021-02-17', NULL, NULL, NULL, 'Per. Rakyat, KP LPJU Bulan Februari 2021', 0, 212924291, 'Transaksi Utama', 'admin', '35'),
(128, '2021-02-18', NULL, NULL, NULL, 'Sosial Permintaan UP TA. 2021', 0, 235686000, 'Transaksi Utama', 'admin', '35'),
(129, '2021-02-18', NULL, NULL, NULL, 'Inspektorat Permintaan UP TA. 2021', 0, 283820000, 'Transaksi Utama', 'admin', '35'),
(130, '2021-02-18', NULL, NULL, NULL, 'Dinas Pemberdayaan Perempuan dan Perlindungan Anak Gaji Terusan An. Masnilam Daulay', 0, 22858800, 'Transaksi Utama', 'admin', '35'),
(131, '2021-02-18', NULL, NULL, NULL, 'Dinas Pendidikan Gaji Terusan Februari 2021', 0, 125247639, 'Transaksi Utama', 'admin', '35'),
(132, '2021-02-18', NULL, NULL, NULL, 'BPBD Permintaan UP TA. 2021', 0, 119681000, 'Transaksi Utama', 'admin', '35'),
(133, '2021-02-18', NULL, NULL, NULL, 'Perdagangan Permintaan UP TA. 2021', 0, 352000000, 'Transaksi Utama', 'admin', '35'),
(134, '2021-02-19', NULL, NULL, NULL, 'BKD Permintaan UP TA. 2021', 0, 174279000, 'Transaksi Utama', 'admin', '35'),
(135, '2021-02-19', NULL, NULL, NULL, 'Kec. Psp Utara Permintaan Uang Persediaan (UP) TA. 2021', 0, 108721000, 'Transaksi Utama', 'admin', '35'),
(136, '2021-02-19', NULL, NULL, NULL, 'Kec. Psp Hutaimbaru Permintaan UP TA. 2021', 0, 60390000, 'Transaksi Utama', 'admin', '35'),
(137, '2021-02-19', NULL, NULL, NULL, 'PMD Permintaan UP TA. 2021', 0, 110680000, 'Transaksi Utama', 'admin', '35'),
(138, '2021-02-19', NULL, NULL, NULL, 'Kec. Psp Selatan Gaji Februari 2021', 0, 431229137, 'Transaksi Utama', 'admin', '35'),
(139, '2021-02-22', NULL, NULL, NULL, 'Dinas Kesehatan Gaji Terusan Februari 2021', 0, 22072245, 'Transaksi Utama', 'admin', '35'),
(141, '2021-02-23', NULL, NULL, NULL, 'Perhubungan Permintaan UP TA. 2021', 0, 135643000, 'Transaksi Utama', 'admin', '35'),
(163, '2021-01-04', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 527048, 0, 'Transaksi Utama', 'admin', '35'),
(164, '2021-01-04', NULL, NULL, NULL, 'Pengembalian Lebih Bayar Peningkatan Gg. Setia Budi Kel. Padangmatinggi Psp Selatan CV. Balakka', 1500000, 0, 'Transaksi Utama', 'admin', '35'),
(165, '2021-01-04', NULL, NULL, NULL, 'Penerimaan Dana Transfer Pusat DAU Januari 2021', 40298352000, 0, 'Transaksi Utama', 'admin', '35'),
(166, '2021-01-05', NULL, NULL, NULL, 'Pengembalian Kelebihan Bayar ATK TA. 2018', 5000000, 0, 'Transaksi Utama', 'admin', '35'),
(167, '2021-01-07', NULL, NULL, NULL, 'Pengembalian Lebih Bayar Peningkatan Gg pada Lk I Desa Batang Bahal Dinas Permukiman An. Aslamiah Hr', 1000000, 0, 'Transaksi Utama', 'admin', '35'),
(168, '2021-01-08', NULL, NULL, NULL, 'Pengembalian Anggaran BTT Dinas Sosial', 25000, 0, 'Transaksi Utama', 'admin', '35'),
(169, '2021-01-11', NULL, NULL, NULL, 'Pengembalian Lebih Bayar Belanja Penggandaan Bag. Organisasi Setda Kota TA. 2020', 14169347, 0, 'Transaksi Utama', 'admin', '35'),
(170, '2021-01-12', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 481040, 0, 'Transaksi Utama', 'admin', '35'),
(171, '2021-01-12', NULL, NULL, NULL, 'Pengembalian Lebih Bayar Belanja Fotocopy Bag. Hukum Setda Kota Padangsidimpuan', 5278408, 0, 'Transaksi Utama', 'admin', '35'),
(172, '2021-01-13', NULL, NULL, NULL, 'PAD Bakeuda Pajak Restoran', 3123500, 0, 'Transaksi Utama', 'admin', '35'),
(173, '2021-01-13', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 3715616, 0, 'Transaksi Utama', 'admin', '35'),
(174, '2021-01-13', NULL, NULL, NULL, 'PAD Bakeuda Pajak Hotel', 3300000, 0, 'Transaksi Utama', 'admin', '35'),
(175, '2021-01-13', NULL, NULL, NULL, 'Pengembalian Kelebihan Pembayaran Barang dan Jasa Dinas Pendidikan Temuan BPK 2020', 1412956, 0, 'Transaksi Utama', 'admin', '35'),
(176, '2021-01-13', NULL, NULL, NULL, 'Pengembalian Kelebihan Pembayaran Barang dan Jasa Dinas Pendidikan Temuan BPK 2020', 2874000, 0, 'Transaksi Utama', 'admin', '35'),
(177, '2021-01-13', NULL, NULL, NULL, 'Pengembalian Kelebihan Pembayaran Barang dan Jasa Dinas Pendidikan Temuan BPK 2020', 617974, 0, 'Transaksi Utama', 'admin', '35'),
(178, '2021-01-13', NULL, NULL, NULL, 'Pengembalian Kelebihan Pembayaran Barang dan Jasa Dinas Pendidikan Temuan BPK 2020', 215909, 0, 'Transaksi Utama', 'admin', '35'),
(179, '2021-01-13', NULL, NULL, NULL, 'Pengembalian Kelebihan Pembayaran Barang dan Jasa Dinas Pendidikan Temuan BPK 2020', 19633022, 0, 'Transaksi Utama', 'admin', '35'),
(180, '2021-01-14', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 6586267, 0, 'Transaksi Utama', 'admin', '35'),
(181, '2021-01-14', NULL, NULL, NULL, 'PAD Bakeuda Pajak Restoran', 125563040, 0, 'Transaksi Utama', 'admin', '35'),
(182, '2021-01-14', NULL, NULL, NULL, 'PAD Bakeuda Pajak Reklame', 9293750, 0, 'Transaksi Utama', 'admin', '35'),
(183, '2021-01-14', NULL, NULL, NULL, 'Pengembalian Temuan BPK dari Kegiatan Kel. Aek Tampang', 13413789.5, 0, 'Transaksi Utama', 'admin', '35'),
(184, '2021-01-14', NULL, NULL, NULL, 'Pengembalian Kelebihan Bayar Penggandaan/ Fotocopy 2020', 2710506, 0, 'Transaksi Utama', 'admin', '35'),
(185, '2021-01-14', NULL, NULL, NULL, 'Pengembalian Kelebihan Bayar Belanja Barang dan Jasa Dinas Pertanian', 15000000, 0, 'Transaksi Utama', 'admin', '35'),
(186, '2021-01-15', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 430931, 0, 'Transaksi Utama', 'admin', '35'),
(187, '2021-01-15', NULL, NULL, NULL, 'PAD Bakeuda Pajak Reklame', 11317250, 0, 'Transaksi Utama', 'admin', '35'),
(188, '2021-01-15', NULL, NULL, NULL, 'PAD Bakeuda Penerimaan BPHTB Bagian Pemko Psp', 5000000, 0, 'Transaksi Utama', 'admin', '35'),
(189, '2021-01-15', NULL, NULL, NULL, 'PAD Bakeuda PPJU dari PLN', 711449202, 0, 'Transaksi Utama', 'admin', '35'),
(190, '2021-01-15', NULL, NULL, NULL, 'Pengembalian Kelebihan Barang dan Jasa (Sewa)', 30451274, 0, 'Transaksi Utama', 'admin', '35'),
(191, '2021-01-18', NULL, NULL, NULL, 'PAD Bakeuda Pajak Restoran (Katering)', 120800, 0, 'Transaksi Utama', 'admin', '35'),
(192, '2021-01-18', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 1618563, 0, 'Transaksi Utama', 'admin', '35'),
(193, '2021-01-18', NULL, NULL, NULL, 'PAD Bakeuda Penerimaan BPHTB Bagian Pemko Psp', 6602850, 0, 'Transaksi Utama', 'admin', '35'),
(194, '2021-01-18', NULL, NULL, NULL, 'Pengembalian Dana Bantuan yang tidak diserahkan pada Panti Asuhan', 28000000, 0, 'Transaksi Utama', 'admin', '35'),
(195, '2021-01-19', NULL, NULL, NULL, 'PAD Bakeuda Pajak Restoran (Katering)', 1306000, 0, 'Transaksi Utama', 'admin', '35'),
(196, '2021-01-19', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 2595751, 0, 'Transaksi Utama', 'admin', '35'),
(197, '2021-01-19', NULL, NULL, NULL, 'PAD Bakeuda Pajak Reklame', 3166950, 0, 'Transaksi Utama', 'admin', '35'),
(198, '2021-01-19', NULL, NULL, NULL, 'PAD Bakeuda Penerimaan BPHTB Bagian Pemko Psp', 5700000, 0, 'Transaksi Utama', 'admin', '35'),
(199, '2021-01-19', NULL, NULL, NULL, 'Pengembalian Kelebihan Bayar Atas Ippd/LKPJ 2020 Setda Bag. Pemerintahan', 16000000, 0, 'Transaksi Utama', 'admin', '35'),
(200, '2021-01-20', NULL, NULL, NULL, 'PAD Bakeuda Pajak Restoran (Katering)', 1000000, 0, 'Transaksi Utama', 'admin', '35'),
(201, '2021-01-20', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 5757979, 0, 'Transaksi Utama', 'admin', '35'),
(202, '2021-01-20', NULL, NULL, NULL, 'PAD Bakeuda Pajak Reklame', 2972500, 0, 'Transaksi Utama', 'admin', '35'),
(203, '2021-01-20', NULL, NULL, NULL, 'PAD Bakeuda Penerimaan BPHTB Bagian Pemko Psp', 44800000, 0, 'Transaksi Utama', 'admin', '35'),
(204, '2021-01-20', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Parkir', 10000000, 0, 'Transaksi Utama', 'admin', '35'),
(205, '2021-01-20', NULL, NULL, NULL, 'PAD Perhubungan Retribusi PKD (PKB)', 11380000, 0, 'Transaksi Utama', 'admin', '35'),
(206, '2021-01-20', NULL, NULL, NULL, 'Pengembalian Kegiatan Rehab Jalan pada Kel. Wek II', 3000000, 0, 'Transaksi Utama', 'admin', '35'),
(207, '2021-01-20', NULL, NULL, NULL, 'Pengembalian Belanja Jasa Kantor Tunj. Insentif Covid-19 Puskesmas Sadabuan', 18181000, 0, 'Transaksi Utama', 'admin', '35'),
(208, '2021-01-21', NULL, NULL, NULL, 'PAD Bakeuda Pajak Restoran (Katering)', 760000, 0, 'Transaksi Utama', 'admin', '35'),
(209, '2021-01-21', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 1724067, 0, 'Transaksi Utama', 'admin', '35'),
(210, '2021-01-21', NULL, NULL, NULL, 'PAD Bakeuda Pajak Reklame', 22862500, 0, 'Transaksi Utama', 'admin', '35'),
(211, '2021-01-21', NULL, NULL, NULL, 'PAD Bakeuda Penerimaan BPHTB Bagian Pemko Psp', 30270000, 0, 'Transaksi Utama', 'admin', '35'),
(212, '2021-01-21', NULL, NULL, NULL, 'PAD Kec. Psp Utara Retribusi IMB', 729000, 0, 'Transaksi Utama', 'admin', '35'),
(213, '2021-01-21', NULL, NULL, NULL, 'Pengembalian Sisa BTT 2020 Dinas Perdagangan', 167693821, 0, 'Transaksi Utama', 'admin', '35'),
(214, '2021-01-21', NULL, NULL, NULL, 'Pengembalian Kekurangan Volume Pek. Pemb. Gg. Idaman Kel. Kantin', 2000000, 0, 'Transaksi Utama', 'admin', '35'),
(215, '2021-01-21', NULL, NULL, NULL, 'Pengembalian Kekurangan Volume Pekerjaan Kel. Batang Ayumi Julu', 2082537.55, 0, 'Transaksi Utama', 'admin', '35'),
(216, '2021-01-21', NULL, NULL, NULL, 'Pengembalian Kelebihan Bayar Barang dan Jasa Dinas Kependudukan dan Capil', 28619770, 0, 'Transaksi Utama', 'admin', '35'),
(217, '2021-01-21', NULL, NULL, NULL, 'Pengembalian Tunj. Camat Padangsidimpuan Hutaimbaru Januari 2021', 1075000, 0, 'Transaksi Utama', 'admin', '35'),
(218, '2021-01-21', NULL, NULL, NULL, 'Pengembalian Biaya DAK non Fisik PAUD Mawar', 200000, 0, 'Transaksi Utama', 'admin', '35'),
(219, '2021-01-22', NULL, NULL, NULL, 'PAD Bakeuda Pajak Restoran (Katering)', 674000, 0, 'Transaksi Utama', 'admin', '35'),
(220, '2021-01-22', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 2096209, 0, 'Transaksi Utama', 'admin', '35'),
(221, '2021-01-22', NULL, NULL, NULL, 'PAD PMPTSP Retribusi IMB', 3616000, 0, 'Transaksi Utama', 'admin', '35'),
(222, '2021-01-22', NULL, NULL, NULL, 'PAD Bakeuda Penerimaan BPHTB Bagian Pemko Psp', 25000, 0, 'Transaksi Utama', 'admin', '35'),
(223, '2021-01-25', NULL, NULL, NULL, 'PAD Bakeuda Pajak Restoran (Katering)', 3029500, 0, 'Transaksi Utama', 'admin', '35'),
(224, '2021-01-25', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 2901401, 0, 'Transaksi Utama', 'admin', '35'),
(225, '2021-01-25', NULL, NULL, NULL, 'PAD PUPR Retribusi PKD Kendaraan Bermotor', 6080000, 0, 'Transaksi Utama', 'admin', '35'),
(226, '2021-01-25', NULL, NULL, NULL, 'PAD Bakeuda Penerimaan BPHTB Bagian Pemko Psp', 1750000, 0, 'Transaksi Utama', 'admin', '35'),
(227, '2021-01-25', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Terminal', 9450000, 0, 'Transaksi Utama', 'admin', '35'),
(228, '2021-01-25', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Parkir', 2345000, 0, 'Transaksi Utama', 'admin', '35'),
(229, '2021-01-26', NULL, NULL, NULL, 'PAD Bakeuda Pajak Restoran (Katering)', 115000, 0, 'Transaksi Utama', 'admin', '35'),
(230, '2021-01-26', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 1105414, 0, 'Transaksi Utama', 'admin', '35'),
(231, '2021-01-26', NULL, NULL, NULL, 'PAD Bakeuda Pajak Reklame', 1590625, 0, 'Transaksi Utama', 'admin', '35'),
(232, '2021-01-26', NULL, NULL, NULL, 'PAD Bakeuda Penerimaan BPHTB Bagian Pemko Psp', 2525000, 0, 'Transaksi Utama', 'admin', '35'),
(233, '2021-01-26', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Parkir Tepi Jalan', 4712000, 0, 'Transaksi Utama', 'admin', '35'),
(234, '2021-01-26', NULL, NULL, NULL, 'Pengembalian Perjalanan Dinas Luar Daerah Dinas Sosial', 45000, 0, 'Transaksi Utama', 'admin', '35'),
(235, '2021-01-27', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 1770561, 0, 'Transaksi Utama', 'admin', '35'),
(236, '2021-01-27', NULL, NULL, NULL, 'PAD Bakeuda Pajak Hiburan', 2500000, 0, 'Transaksi Utama', 'admin', '35'),
(237, '2021-01-27', NULL, NULL, NULL, 'PAD Bakeuda Penerimaan BPHTB Bagian Pemko Psp', 3000000, 0, 'Transaksi Utama', 'admin', '35'),
(238, '2021-01-27', NULL, NULL, NULL, 'PAD Perdagangan Retribusi Pelayanan Pasar', 10615575, 0, 'Transaksi Utama', 'admin', '35'),
(239, '2021-01-27', NULL, NULL, NULL, 'PAD Perdagangan Retribusi Pelayanan Sampah', 4048000, 0, 'Transaksi Utama', 'admin', '35'),
(240, '2021-01-27', NULL, NULL, NULL, 'Pengembalian Kelebihan Bayar CV. PH Hasil LHP BPK', 4440962.41, 0, 'Transaksi Utama', 'admin', '35'),
(241, '2021-01-27', NULL, NULL, NULL, 'Pengembalian Gaji/Tunjangan Januari 2021 Dinas Kesehatan', 3295300, 0, 'Transaksi Utama', 'admin', '35'),
(242, '2021-01-27', NULL, NULL, NULL, 'Penerimaan DBH SDA Minerba Triw. I TA. 2021', 205929600, 0, 'Transaksi Utama', 'admin', '35'),
(243, '2021-01-27', NULL, NULL, NULL, 'Penerimaan DBH SDA Minerba Triw. I TA. 2021', 465512200, 0, 'Transaksi Utama', 'admin', '35'),
(244, '2021-01-27', NULL, NULL, NULL, 'Penerimaan DBH SDA Panas Bumi Triw. I TA. 2021 (Iuran Tetap)', 5149200, 0, 'Transaksi Utama', 'admin', '35'),
(245, '2021-01-27', NULL, NULL, NULL, 'Penerimaan DBH SDA Panas Bumi Triw. I TA. 2021 (Iuran Produksi)', 37690400, 0, 'Transaksi Utama', 'admin', '35'),
(246, '2021-01-27', NULL, NULL, NULL, 'Penerimaan DBH SDA Perikanan Triw. I TA. 2021', 169247850, 0, 'Transaksi Utama', 'admin', '35'),
(247, '2021-01-28', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 1885252, 0, 'Transaksi Utama', 'admin', '35'),
(248, '2021-01-28', NULL, NULL, NULL, 'PAD Perdagangan Retribusi Fasilitas Pasar', 1206000, 0, 'Transaksi Utama', 'admin', '35'),
(249, '2021-01-28', NULL, NULL, NULL, 'Pengembalian Kelebihan Bayar atas Kerugian Negara Rehab. Gg. Serasi Ujung Kel. Kayu Ombun TA. 2017', 1000000, 0, 'Transaksi Utama', 'admin', '35'),
(250, '2021-01-29', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 152310, 0, 'Transaksi Utama', 'admin', '35'),
(251, '2021-01-29', NULL, NULL, NULL, 'PAD Bakeuda Pajak Reklame', 13165700, 0, 'Transaksi Utama', 'admin', '35'),
(252, '2021-01-29', NULL, NULL, NULL, 'PAD Bakeuda Pajak Hotel', 10901727, 0, 'Transaksi Utama', 'admin', '35'),
(253, '2021-01-29', NULL, NULL, NULL, 'PAD Bakeuda Pajak ABT', 2849500, 0, 'Transaksi Utama', 'admin', '35'),
(254, '2021-01-29', NULL, NULL, NULL, 'PAD Bakeuda Pajak Perparkiran', 1000000, 0, 'Transaksi Utama', 'admin', '35'),
(255, '2021-01-29', NULL, NULL, NULL, 'PAD Bakeuda Penerimaan BPHTB Bagian Pemko Psp', 3620050, 0, 'Transaksi Utama', 'admin', '35'),
(256, '2021-01-29', NULL, NULL, NULL, 'PAD Kesehatan Retribusi Pelayanan Kesehatan Puskesmas', 9156000, 0, 'Transaksi Utama', 'admin', '35'),
(257, '2021-01-29', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Parkir', 5075000, 0, 'Transaksi Utama', 'admin', '35'),
(258, '2021-01-29', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Terminal', 7600000, 0, 'Transaksi Utama', 'admin', '35'),
(259, '2021-01-29', NULL, NULL, NULL, 'Pengembalian Biaya DAK non Fisik PAUD Mawar', 4026000, 0, 'Transaksi Utama', 'admin', '35'),
(260, '2021-01-29', NULL, NULL, NULL, 'PAD Lingk. Hidup Retribusi Penyedotan Kakus/Tinja', 1000000, 0, 'Transaksi Utama', 'admin', '35'),
(261, '2021-01-29', NULL, NULL, NULL, 'PAD Perdagangan Retribusi Pelayanan Sampah', 31750000, 0, 'Transaksi Utama', 'admin', '35'),
(262, '2021-01-29', NULL, NULL, NULL, 'PAD Perdagangan Retribusi Pelayanan Pasar', 540000, 0, 'Transaksi Utama', 'admin', '35'),
(263, '2021-01-29', NULL, NULL, NULL, 'PAD Bag. Umum Retribusi Rumah Penginapan', 2800000, 0, 'Transaksi Utama', 'admin', '35'),
(264, '2021-01-29', NULL, NULL, NULL, 'PAD Pertanian Retribusi Pemeriksaan Kesehatan (RPH)', 1050000, 0, 'Transaksi Utama', 'admin', '35'),
(265, '2021-01-29', NULL, NULL, NULL, 'PAD Pertanian Retribusi Penjualan Produksi Usaha Daerah', 350000, 0, 'Transaksi Utama', 'admin', '35'),
(266, '2021-01-29', NULL, NULL, NULL, 'Penerimaan Kontribusi dari PDAM Tirtanadi', 6500000, 0, 'Transaksi Utama', 'admin', '35'),
(267, '2021-01-31', NULL, NULL, NULL, 'PAD Baekuda Penerimaan Jasa Giro Januari 2021', 269730799, 0, 'Transaksi Utama', 'admin', '35'),
(268, '2021-02-01', NULL, NULL, NULL, 'PAD Bakeuda Pajak Restoran', 1240000, 0, 'Transaksi Utama', 'admin', '35'),
(269, '2021-02-01', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 2077640, 0, 'Transaksi Utama', 'admin', '35'),
(270, '2021-02-01', NULL, NULL, NULL, 'PAD Bakeuda Pajak Reklame', 786250, 0, 'Transaksi Utama', 'admin', '35'),
(271, '2021-02-01', NULL, NULL, NULL, 'PAD Bakeuda Penerimaan BPHTB Bagian Pemko Psp', 9050000, 0, 'Transaksi Utama', 'admin', '35'),
(272, '2021-02-01', NULL, NULL, NULL, 'PAD Kesehatan Retribusi Pelayanan Kesehatan Puskesmas', 810000, 0, 'Transaksi Utama', 'admin', '35'),
(273, '2021-02-01', NULL, NULL, NULL, 'PAD PUPR Retribusi PKD Kendaraan Bermotor', 4320000, 0, 'Transaksi Utama', 'admin', '35'),
(274, '2021-02-01', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Parkir', 3232000, 0, 'Transaksi Utama', 'admin', '35'),
(275, '2021-02-01', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Izin Trayek', 60000, 0, 'Transaksi Utama', 'admin', '35'),
(276, '2021-02-01', NULL, NULL, NULL, 'Pengembalian Kelebihan Bayar ATK TA. 2018', 5000000, 0, 'Transaksi Utama', 'admin', '35'),
(277, '2021-02-02', NULL, NULL, NULL, 'PAD Bakeuda Pajak Restoran', 2623400, 0, 'Transaksi Utama', 'admin', '35'),
(278, '2021-02-02', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 594499, 0, 'Transaksi Utama', 'admin', '35'),
(279, '2021-02-02', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Parkir', 2430000, 0, 'Transaksi Utama', 'admin', '35'),
(280, '2021-02-02', NULL, NULL, NULL, 'PAD Perdagangan Retribusi Pelayanan Pasar', 3133000, 0, 'Transaksi Utama', 'admin', '35'),
(281, '2021-02-02', NULL, NULL, NULL, 'PAD Perdagangan Retribusi Pelayanan Sampah', 1552000, 0, 'Transaksi Utama', 'admin', '35'),
(282, '2021-02-02', NULL, NULL, NULL, 'PAD PMPTSP Retribusi IMB', 12446000, 0, 'Transaksi Utama', 'admin', '35'),
(283, '2021-02-02', NULL, NULL, NULL, 'Penerimaa Setoran dari PT. Anugerah Tetap Cemerlang (ATC)', 55000000, 0, 'Transaksi Utama', 'admin', '35'),
(284, '2021-02-03', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 2001977, 0, 'Transaksi Utama', 'admin', '35'),
(285, '2021-02-03', NULL, NULL, NULL, 'PAD Bakeuda Pajak Reklame', 45022500, 0, 'Transaksi Utama', 'admin', '35'),
(286, '2021-02-03', NULL, NULL, NULL, 'PAD Bakeuda Penerimaan BPHTB Bagian Pemko Psp', 5380000, 0, 'Transaksi Utama', 'admin', '35'),
(287, '2021-02-03', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Parkir', 2667000, 0, 'Transaksi Utama', 'admin', '35'),
(288, '2021-02-03', NULL, NULL, NULL, 'PAD PUPR Retribusi PKD Kendaraan Bermotor', 5280000, 0, 'Transaksi Utama', 'admin', '35'),
(289, '2021-02-04', NULL, NULL, NULL, 'PAD Bakeuda Pajak Restoran', 860000, 0, 'Transaksi Utama', 'admin', '35'),
(290, '2021-02-04', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 2297128, 0, 'Transaksi Utama', 'admin', '35'),
(291, '2021-02-04', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Parkir Tepi Jalan', 1450000, 0, 'Transaksi Utama', 'admin', '35'),
(292, '2021-02-04', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Terminal', 600000, 0, 'Transaksi Utama', 'admin', '35'),
(293, '2021-02-04', NULL, NULL, NULL, 'Pengembalian Tamb. Pengh. Berd. Beban Kerja Oktober s/d Desember 2021 Dinas Pendidikan', 1912500, 0, 'Transaksi Utama', 'admin', '35'),
(294, '2021-02-05', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 359529, 0, 'Transaksi Utama', 'admin', '35'),
(295, '2021-02-08', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 1973069, 0, 'Transaksi Utama', 'admin', '35'),
(296, '2021-02-08', NULL, NULL, NULL, 'PAD Bakeuda Pajak Reklame', 19445000, 0, 'Transaksi Utama', 'admin', '35'),
(297, '2021-02-08', NULL, NULL, NULL, 'PAD Bakeuda Penerimaan BPHTB Bagian Pemko Psp', 1336600, 0, 'Transaksi Utama', 'admin', '35'),
(298, '2021-02-08', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Parkir Tepi Jalan', 489000, 0, 'Transaksi Utama', 'admin', '35'),
(299, '2021-02-08', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Terminal', 1695000, 0, 'Transaksi Utama', 'admin', '35'),
(300, '2021-02-08', NULL, NULL, NULL, 'PAD PMPTSP Retribusi IMB', 28516000, 0, 'Transaksi Utama', 'admin', '35'),
(301, '2021-02-09', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 1964807, 0, 'Transaksi Utama', 'admin', '35'),
(302, '2021-02-09', NULL, NULL, NULL, 'PAD Kesehatan Retribusi Pelayanan Kesehatan Puskesmas', 265000, 0, 'Transaksi Utama', 'admin', '35'),
(303, '2021-02-09', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Terminal', 704000, 0, 'Transaksi Utama', 'admin', '35'),
(304, '2021-02-09', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Parkir Tepi Jalan', 4262000, 0, 'Transaksi Utama', 'admin', '35'),
(305, '2021-02-09', NULL, NULL, NULL, 'PAD PMPTSP Retribusi IMB', 13350000, 0, 'Transaksi Utama', 'admin', '35'),
(306, '2021-02-09', NULL, NULL, NULL, 'Pengembalian dari Gaji Pensiun PT. Taspen', 466951, 0, 'Transaksi Utama', 'admin', '35'),
(307, '2021-02-09', NULL, NULL, NULL, 'Pengembalian Lebih Bayar Peningkatan Jln Silandit 2017', 5184086.66, 0, 'Transaksi Utama', 'admin', '35'),
(308, '2021-02-09', NULL, NULL, NULL, 'Pengembalian Lebih Bayar Peningkatan Jalan Baru Hutaimbaru', 10000000, 0, 'Transaksi Utama', 'admin', '35'),
(309, '2021-02-10', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 1164517, 0, 'Transaksi Utama', 'admin', '35'),
(310, '2021-02-10', NULL, NULL, NULL, 'PAD Bakeuda Pajak Reklame', 17725000, 0, 'Transaksi Utama', 'admin', '35'),
(311, '2021-02-10', NULL, NULL, NULL, 'PAD PMPTSP Retribusi IMB', 1822500, 0, 'Transaksi Utama', 'admin', '35'),
(312, '2021-02-10', NULL, NULL, NULL, 'PAD Perdagangan Retribusi Pelayanan Pasar', 86400, 0, 'Transaksi Utama', 'admin', '35'),
(313, '2021-02-10', NULL, NULL, NULL, 'PAD Perdagangan Retribusi Pelayanan Sampah', 36000, 0, 'Transaksi Utama', 'admin', '35'),
(314, '2021-02-10', NULL, NULL, NULL, 'PAD PUPR Retribusi PKD Kendaraan Bermotor', 50000, 0, 'Transaksi Utama', 'admin', '35'),
(315, '2021-02-10', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Parkir Tepi Jalan', 1780000, 0, 'Transaksi Utama', 'admin', '35'),
(316, '2021-02-10', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Terminal', 720000, 0, 'Transaksi Utama', 'admin', '35'),
(317, '2021-02-11', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 2455111, 0, 'Transaksi Utama', 'admin', '35'),
(318, '2021-02-11', NULL, NULL, NULL, 'PAD Bakeuda Pajak Reklame', 2548750, 0, 'Transaksi Utama', 'admin', '35'),
(319, '2021-02-11', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Parkir Tepi Jalan', 2590000, 0, 'Transaksi Utama', 'admin', '35'),
(320, '2021-02-11', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Terminal', 680000, 0, 'Transaksi Utama', 'admin', '35'),
(321, '2021-02-11', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Izin Trayek', 20000, 0, 'Transaksi Utama', 'admin', '35'),
(322, '2021-02-15', NULL, NULL, NULL, 'PAD Bakeuda Pajak Restoran (Katering)', 107977333, 0, 'Transaksi Utama', 'admin', '35'),
(323, '2021-02-15', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 1600261, 0, 'Transaksi Utama', 'admin', '35'),
(324, '2021-02-15', NULL, NULL, NULL, 'PAD Bakeuda Pajak Reklame', 1584000, 0, 'Transaksi Utama', 'admin', '35'),
(325, '2021-02-15', NULL, NULL, NULL, 'PAD PMPTSP Retribusi IMB', 9757200, 0, 'Transaksi Utama', 'admin', '35'),
(326, '2021-02-15', NULL, NULL, NULL, 'PAD Perdagangan Retribusi Fasilitas Pasar', 2508000, 0, 'Transaksi Utama', 'admin', '35'),
(327, '2021-02-15', NULL, NULL, NULL, 'PAD Perdagangan Retribusi Persampahan', 128000, 0, 'Transaksi Utama', 'admin', '35'),
(328, '2021-02-15', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Terminal', 2350000, 0, 'Transaksi Utama', 'admin', '35'),
(329, '2021-02-15', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Parkir', 1875000, 0, 'Transaksi Utama', 'admin', '35'),
(330, '2021-02-15', NULL, NULL, NULL, 'Pengembalian Gaji / Tunjangan Januari 2021 SMPN 9', 5600900, 0, 'Transaksi Utama', 'admin', '35'),
(331, '2021-02-16', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 1564099, 0, 'Transaksi Utama', 'admin', '35'),
(332, '2021-02-16', NULL, NULL, NULL, 'PAD Bakeuda Pajak Hotel', 3750000, 0, 'Transaksi Utama', 'admin', '35'),
(333, '2021-02-16', NULL, NULL, NULL, 'PAD Bakeuda Pajak Reklame', 2931250, 0, 'Transaksi Utama', 'admin', '35'),
(334, '2021-02-16', NULL, NULL, NULL, 'PAD Bakeuda Penerimaan BPHTB Bagian Pemko Psp', 9294925, 0, 'Transaksi Utama', 'admin', '35'),
(335, '2021-02-16', NULL, NULL, NULL, 'PAD Bakeuda PPJU dari PLN', 708594820, 0, 'Transaksi Utama', 'admin', '35'),
(336, '2021-02-16', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Parkir Tepi Jalan', 1140000, 0, 'Transaksi Utama', 'admin', '35'),
(337, '2021-02-16', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Terminal', 1400000, 0, 'Transaksi Utama', 'admin', '35'),
(338, '2021-02-16', NULL, NULL, NULL, 'Pengembalian Kekurangan Volume Pekerjaan Pemb. Trotoar Jln Kpaten Tendean Kel. Bincar', 9645533.66, 0, 'Transaksi Utama', 'admin', '35'),
(339, '2021-02-17', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 797329, 0, 'Transaksi Utama', 'admin', '35'),
(340, '2021-02-17', NULL, NULL, NULL, 'PAD Bakeuda Pajak Reklame', 5236875, 0, 'Transaksi Utama', 'admin', '35'),
(341, '2021-02-17', NULL, NULL, NULL, 'PAD Bakeuda Penerimaan BPHTB Bagian Pemko Psp', 11814300, 0, 'Transaksi Utama', 'admin', '35'),
(342, '2021-02-17', NULL, NULL, NULL, 'PAD Perdagangan Retribusi Persampahan', 900000, 0, 'Transaksi Utama', 'admin', '35'),
(343, '2021-02-17', NULL, NULL, NULL, 'PAD Perdagangan Retribusi Fasilitas Pasar', 4070200, 0, 'Transaksi Utama', 'admin', '35'),
(344, '2021-02-17', NULL, NULL, NULL, 'PAD Kesehatan Retribusi Pelayanan Kesehatan Puskesmas', 235000, 0, 'Transaksi Utama', 'admin', '35'),
(345, '2021-02-17', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Parkir Tepi Jalan', 2246000, 0, 'Transaksi Utama', 'admin', '35'),
(346, '2021-02-17', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Terminal', 816000, 0, 'Transaksi Utama', 'admin', '35'),
(347, '2021-02-18', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 748946, 0, 'Transaksi Utama', 'admin', '35'),
(348, '2021-02-18', NULL, NULL, NULL, 'PAD Bakeuda Pajak Reklame', 8400000, 0, 'Transaksi Utama', 'admin', '35'),
(349, '2021-02-18', NULL, NULL, NULL, 'PAD Bakeuda Pajak Air Bawah Tanah', 50000, 0, 'Transaksi Utama', 'admin', '35'),
(350, '2021-02-18', NULL, NULL, NULL, 'PAD Bakeuda Penerimaan BPHTB Bagian Pemko Psp', 3500000, 0, 'Transaksi Utama', 'admin', '35'),
(351, '2021-02-18', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Parkir Tepi Jalan', 1728000, 0, 'Transaksi Utama', 'admin', '35'),
(352, '2021-02-18', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Terminal', 720000, 0, 'Transaksi Utama', 'admin', '35'),
(353, '2021-02-19', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 835795, 0, 'Transaksi Utama', 'admin', '35'),
(354, '2021-02-19', NULL, NULL, NULL, 'PAD Bakeuda Penerimaan BPHTB Bagian Pemko Psp', 9413500, 0, 'Transaksi Utama', 'admin', '35'),
(355, '2021-02-19', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Terminal', 700000, 0, 'Transaksi Utama', 'admin', '35'),
(356, '2021-02-19', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Parkir Tepi Jalan', 1320000, 0, 'Transaksi Utama', 'admin', '35'),
(357, '2021-02-22', NULL, NULL, NULL, 'PAD Bakeuda Pajak Restoran (Katering)', 1786500, 0, 'Transaksi Utama', 'admin', '35'),
(358, '2021-02-22', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 840280, 0, 'Transaksi Utama', 'admin', '35'),
(359, '2021-02-22', NULL, NULL, NULL, 'PAD Bakeuda Penerimaan BPHTB Bagian Pemko Psp', 10025000, 0, 'Transaksi Utama', 'admin', '35'),
(360, '2021-02-22', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Parkir Tepi Jalan', 2003000, 0, 'Transaksi Utama', 'admin', '35'),
(361, '2021-02-22', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Terminal', 2900000, 0, 'Transaksi Utama', 'admin', '35'),
(362, '2021-02-22', NULL, NULL, NULL, 'Penerimaan Dana Transfer Pusat DAU Januari 2021', 40298352000, 0, 'Transaksi Utama', 'admin', '35'),
(363, '2021-02-23', NULL, NULL, NULL, 'PAD Bakeuda Pajak Restoran (Katering)', 2112500, 0, 'Transaksi Utama', 'admin', '35'),
(364, '2021-02-23', NULL, NULL, NULL, 'PAD Bakeuda Pajak PBB-P2', 8831921, 0, 'Transaksi Utama', 'admin', '35'),
(365, '2021-02-23', NULL, NULL, NULL, 'PAD Bakeuda Penerimaan BPHTB Bagian Pemko Psp', 1775000, 0, 'Transaksi Utama', 'admin', '35'),
(366, '2021-02-23', NULL, NULL, NULL, 'PAD Kesehatan Retribusi Pelayanan Kesehatan Puskesmas', 605000, 0, 'Transaksi Utama', 'admin', '35'),
(367, '2021-02-23', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Terminal', 980000, 0, 'Transaksi Utama', 'admin', '35'),
(368, '2021-02-23', NULL, NULL, NULL, 'PAD Perhubungan Retribusi Parkir', 1630000, 0, 'Transaksi Utama', 'admin', '35'),
(369, '2021-02-23', NULL, NULL, NULL, 'PAD Perdagangan Retribusi Pelayanan Pasar', 8016200, 0, 'Transaksi Utama', 'admin', '35'),
(370, '2021-02-23', NULL, NULL, NULL, 'PAD Perdagangan Retribusi Pelayanan Sampah', 1696000, 0, 'Transaksi Utama', 'admin', '35'),
(371, '2021-02-23', NULL, NULL, NULL, 'Penerimaan DBH SDA Gas Bumi 30% Triw. I 2021', 3604000, 0, 'Transaksi Utama', 'admin', '35'),
(372, '2021-02-23', NULL, NULL, NULL, 'Penerimaan DBH SDA Gas Bumi 0,5% Triw. I 2021', 60000, 0, 'Transaksi Utama', 'admin', '35'),
(373, '2021-02-23', NULL, NULL, NULL, 'Penerimaan DBH SDA Minyak Bumi 15% Triw. I 2021', 590200, 0, 'Transaksi Utama', 'admin', '35'),
(374, '2021-02-23', NULL, NULL, NULL, 'Penerimaan DBH SDA Minyak Bumi 0,5% Triw. I 2021', 19600, 0, 'Transaksi Utama', 'admin', '35'),
(375, '2021-02-23', NULL, NULL, NULL, 'Penerimaan Dana Fasilitas Penanaman Modal Tahap I 2021', 163061000, 0, 'Transaksi Utama', 'admin', '35'),
(418, '2021-02-23', NULL, NULL, NULL, 'Inspektorat Gaji Terusan An. Iskandar Zulkarnaen', 0, 28398150, 'Transaksi Utama', 'admin', '35'),
(419, '2021-02-16', NULL, NULL, NULL, '-', 1412000, 0, 'Transaksi Utama', 'admin', '35');
...
INSERT INTO `user` (`id`, `username`, `password`, `name`, `status`, `is_active`, `id_user`, `id_opd`) VALUES
(1, 'admin', 'admin', 'admin', 'admin', 1, NULL, 35),
(3, 'operator1', 'operator1', 'operator1', 'member', 1, NULL, 1),
(4, 'operator2', 'operator2', 'operator2', 'member', 1, NULL, 1),
(5, 'admin3', 'admin3', 'admin3', 'admin', 1, NULL, 1),
(28, 'operator1', '12345', 'operator1', 'member', 1, 'admin', 35),
(29, 'operator4', '12345', 'operator4', 'member', 1, 'admin', 35),
(30, 'operator4', '12345', 'operator4', 'member', 1, 'admin', 35);
...
--
ALTER TABLE `tbl_apbd`
  MODIFY `id_apbd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `tbl_bbp`
--
ALTER TABLE `tbl_bbp`
  MODIFY `id_bbp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tbl_rekening`
  MODIFY `id_rekening` int(128) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `tbl_transaksi`
  MODIFY `id_transaksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=421;
...
--
ALTER TABLE `user_access_menu`
  MODIFY `id` int(128) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
